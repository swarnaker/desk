...
export function parsePadParam(raw: string | null | undefined): "BOTH" | "ALL" | Pad {
  if (raw === "PONS" || raw === "O1" || raw === "PUMP" || raw === "BASE" || raw === "LONG" || raw === "VIRTUALS" || raw === "CLANKER" || raw === "ARC" || raw === "BOTH") return raw;
  return "BOTH";
}
...
export function radarApiPath(
  ...
  if (pad === "PONS" || pad === "O1" || pad === "PUMP" || pad === "BASE" || pad === "LONG" || pad === "VIRTUALS" || pad === "CLANKER" || pad === "ARC") p.set("pad", pad);
